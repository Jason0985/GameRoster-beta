import{$t as vm,B as UP,F as Rr,Ft as nu,G as Yr,Gt as tI,Ht as se$1,It as pu,Jt as th,Kt as te$1,L as Tg,O as Or,Ot as ln,Pt as nt$1,Q as _t$1,Rt as qn,St as iD,T as M1,W as WP,Wt as sr,Yt as ty,a as $e,b as L$1,c as Ar,dt as eI,en as y$1,f as Em,ht as g,k as P$1,lt as dm,m as G$1,mt as fu,n as $,o as $h,ot as ce$1,s as Ai,st as ch,ut as du,vt as gu,w as M,wt as ke,x as LC,xt as hu,y as Ki}from"./main-FGVVPNZS.js";function j(n){return n.buttons===0||n.detail===0}function z(n){let o=n.touches&&n.touches[0]||n.changedTouches&&n.changedTouches[0];return!!o&&o.identifier===-1&&(o.radiusX==null||o.radiusX===1)&&(o.radiusY==null||o.radiusY===1)}var st;function zt(){if(st==null){let n=typeof document<`u`?document.head:null;st=!!(n&&(n.createShadowRoot||n.attachShadow))}return st}function ct(n){if(zt()){let o=n.getRootNode?n.getRootNode():null;if(typeof ShadowRoot<`u`&&ShadowRoot&&o instanceof ShadowRoot)return o}return null}function h(n){if(n.composedPath)try{return n.composedPath()[0]}catch{}return n.target}var dt;try{dt=typeof Intl<`u`&&Intl.v8BreakIterator}catch{dt=!1}var y=(()=>{class n{_platformId=g(Rr);isBrowser=this._platformId?M1(this._platformId):typeof document==`object`&&!!document;EDGE=this.isBrowser&&/(edge)/i.test(navigator.userAgent);TRIDENT=this.isBrowser&&/(msie|trident)/i.test(navigator.userAgent);BLINK=this.isBrowser&&!!(window.chrome||dt)&&typeof CSS<`u`&&!this.EDGE&&!this.TRIDENT;WEBKIT=this.isBrowser&&/AppleWebKit/i.test(navigator.userAgent)&&!this.BLINK&&!this.EDGE&&!this.TRIDENT;IOS=this.isBrowser&&/iPad|iPhone|iPod/.test(navigator.userAgent)&&!(`MSStream`in window);FIREFOX=this.isBrowser&&/(firefox|minefield)/i.test(navigator.userAgent);ANDROID=this.isBrowser&&/android/i.test(navigator.userAgent)&&!this.TRIDENT;SAFARI=this.isBrowser&&/safari/i.test(navigator.userAgent)&&this.WEBKIT;static ɵfac=function(e){return new(e||n)};static ɵprov=se$1({token:n,factory:n.ɵfac})}return n})();var U;function Ut(){if(U==null&&typeof window<`u`)try{window.addEventListener(`test`,null,Object.defineProperty({},"passive",{get:()=>U=!0}))}finally{U=U||!1}return U}function L(n){return Ut()?n:!!n.capture}function x(n){return n instanceof _t$1?n.nativeElement:n}var Vt=new y$1(`cdk-input-modality-detector-options`);var Gt={ignoreKeys:[18,17,224,91,16]};var Zt=650;var mt={passive:!0,capture:!0};var Ht=(()=>{class n{_platform=g(y);_listenerCleanups;modalityDetected;modalityChanged;get mostRecentModality(){return this._modality.value}_mostRecentTarget=null;_modality=new sr(null);_options;_lastTouchMs=0;_onKeydown=t=>{this._options?.ignoreKeys?.some(e=>e===t.keyCode)||(this._modality.next(`keyboard`),this._mostRecentTarget=h(t))};_onMousedown=t=>{Date.now()-this._lastTouchMs<Zt||(this._modality.next(j(t)?`keyboard`:`mouse`),this._mostRecentTarget=h(t))};_onTouchstart=t=>{if(z(t)){this._modality.next(`keyboard`);return}this._lastTouchMs=Date.now(),this._modality.next(`touch`),this._mostRecentTarget=h(t)};constructor(){let t=g(te$1),e=g(P$1),a=g(Vt,{optional:!0});if(this._options=L$1(L$1({},Gt),a),this.modalityDetected=this._modality.pipe(vm(1)),this.modalityChanged=this.modalityDetected.pipe(dm()),this._platform.isBrowser){let r=g(ln).createRenderer(null,null);this._listenerCleanups=t.runOutsideAngular(()=>[r.listen(e,`keydown`,this._onKeydown,mt),r.listen(e,`mousedown`,this._onMousedown,mt),r.listen(e,`touchstart`,this._onTouchstart,mt)])}}ngOnDestroy(){this._modality.complete(),this._listenerCleanups?.forEach(t=>t())}static ɵfac=function(e){return new(e||n)};static ɵprov=se$1({token:n,factory:n.ɵfac})}return n})();var V=(function(n){return n[n.IMMEDIATE=0]=`IMMEDIATE`,n[n.EVENTUAL=1]=`EVENTUAL`,n})(V||{});var $t=new y$1(`cdk-focus-monitor-default-options`);var J=L({passive:!0,capture:!0});var lt=(()=>{class n{_ngZone=g(te$1);_platform=g(y);_inputModalityDetector=g(Ht);_origin=null;_lastFocusOrigin=null;_windowFocused=!1;_windowFocusTimeoutId;_originTimeoutId;_originFromTouchInteraction=!1;_elementInfo=new Map;_monitoredElementCount=0;_rootNodeFocusListenerCount=new Map;_detectionMode;_windowFocusListener=()=>{this._windowFocused=!0,this._windowFocusTimeoutId=setTimeout(()=>this._windowFocused=!1)};_document=g(P$1);_stopInputModalityDetector=new G$1;constructor(){let t=g($t,{optional:!0});this._detectionMode=t?.detectionMode||V.IMMEDIATE}_rootNodeFocusAndBlurListener=t=>{let e=h(t);for(let a=e;a;a=a.parentElement)t.type===`focus`?this._onFocus(t,a):this._onBlur(t,a)};monitor(t,e=!1){let a=x(t);if(!this._platform.isBrowser||a.nodeType!==1)return $e();let r=ct(a)||this._document,s=this._elementInfo.get(a);if(s)return e&&(s.checkChildren=!0),s.subject;let f={checkChildren:e,subject:new G$1,rootNode:r};return this._elementInfo.set(a,f),this._registerGlobalListeners(f),f.subject}stopMonitoring(t){let e=x(t),a=this._elementInfo.get(e);a&&(a.subject.complete(),this._setClasses(e),this._elementInfo.delete(e),this._removeGlobalListeners(a))}focusVia(t,e,a){let r=x(t);r===this._document.activeElement?this._getClosestElementsInfo(r).forEach(([f,A])=>this._originChanged(f,e,A)):(this._setOrigin(e),typeof r.focus==`function`&&r.focus(a))}ngOnDestroy(){this._elementInfo.forEach((t,e)=>this.stopMonitoring(e))}_getWindow(){return this._document.defaultView||window}_getFocusOrigin(t){return this._origin?this._originFromTouchInteraction?this._shouldBeAttributedToTouch(t)?`touch`:`program`:this._origin:this._windowFocused&&this._lastFocusOrigin?this._lastFocusOrigin:t&&this._isLastInteractionFromInputLabel(t)?`mouse`:`program`}_shouldBeAttributedToTouch(t){return this._detectionMode===V.EVENTUAL||!!t?.contains(this._inputModalityDetector._mostRecentTarget)}_setClasses(t,e){t.classList.toggle(`cdk-focused`,!!e),t.classList.toggle(`cdk-touch-focused`,e===`touch`),t.classList.toggle(`cdk-keyboard-focused`,e===`keyboard`),t.classList.toggle(`cdk-mouse-focused`,e===`mouse`),t.classList.toggle(`cdk-program-focused`,e===`program`)}_setOrigin(t,e=!1){this._ngZone.runOutsideAngular(()=>{if(this._origin=t,this._originFromTouchInteraction=t===`touch`&&e,this._detectionMode===V.IMMEDIATE){clearTimeout(this._originTimeoutId);let a=this._originFromTouchInteraction?Zt:1;this._originTimeoutId=setTimeout(()=>this._origin=null,a)}})}_onFocus(t,e){let a=this._elementInfo.get(e),r=h(t);!a||!a.checkChildren&&e!==r||this._originChanged(e,this._getFocusOrigin(r),a)}_onBlur(t,e){let a=this._elementInfo.get(e);!a||a.checkChildren&&t.relatedTarget instanceof Node&&e.contains(t.relatedTarget)||(this._setClasses(e),this._emitOrigin(a,null))}_emitOrigin(t,e){t.subject.observers.length&&this._ngZone.run(()=>t.subject.next(e))}_registerGlobalListeners(t){if(!this._platform.isBrowser)return;let e=t.rootNode,a=this._rootNodeFocusListenerCount.get(e)||0;a||this._ngZone.runOutsideAngular(()=>{e.addEventListener(`focus`,this._rootNodeFocusAndBlurListener,J),e.addEventListener(`blur`,this._rootNodeFocusAndBlurListener,J)}),this._rootNodeFocusListenerCount.set(e,a+1),++this._monitoredElementCount===1&&(this._ngZone.runOutsideAngular(()=>{this._getWindow().addEventListener(`focus`,this._windowFocusListener)}),this._inputModalityDetector.modalityDetected.pipe(Em(this._stopInputModalityDetector)).subscribe(r=>{this._setOrigin(r,!0)}))}_removeGlobalListeners(t){let e=t.rootNode;if(this._rootNodeFocusListenerCount.has(e)){let a=this._rootNodeFocusListenerCount.get(e);a>1?this._rootNodeFocusListenerCount.set(e,a-1):(e.removeEventListener(`focus`,this._rootNodeFocusAndBlurListener,J),e.removeEventListener(`blur`,this._rootNodeFocusAndBlurListener,J),this._rootNodeFocusListenerCount.delete(e))}--this._monitoredElementCount||(this._getWindow().removeEventListener(`focus`,this._windowFocusListener),this._stopInputModalityDetector.next(),clearTimeout(this._windowFocusTimeoutId),clearTimeout(this._originTimeoutId))}_originChanged(t,e,a){this._setClasses(t,e),this._emitOrigin(a,e),this._lastFocusOrigin=e}_getClosestElementsInfo(t){let e=[];return this._elementInfo.forEach((a,r)=>{(r===t||a.checkChildren&&r.contains(t))&&e.push([r,a])}),e}_isLastInteractionFromInputLabel(t){let{_mostRecentTarget:e,mostRecentModality:a}=this._inputModalityDetector;if(a!==`mouse`||!e||e===t||t.nodeName!==`INPUT`&&t.nodeName!==`TEXTAREA`||t.disabled)return!1;let r=t.labels;if(r){for(let s=0;s<r.length;s++)if(r[s].contains(e))return!0}return!1}static ɵfac=function(e){return new(e||n)};static ɵprov=se$1({token:n,factory:n.ɵfac})}return n})();var Yt=new Set;var k;var ut=(()=>{class n{_platform=g(y);_nonce=g(Or,{optional:!0});_matchMedia;constructor(){this._matchMedia=this._platform.isBrowser&&window.matchMedia?window.matchMedia.bind(window):be}matchMedia(t){return(this._platform.WEBKIT||this._platform.BLINK)&&ue(t,this._nonce),this._matchMedia(t)}static ɵfac=function(e){return new(e||n)};static ɵprov=se$1({token:n,factory:n.ɵfac})}return n})();function ue(n,o){if(!Yt.has(n))try{k||(k=document.createElement(`style`),o&&k.setAttribute(`nonce`,o),k.setAttribute(`type`,`text/css`),document.head.appendChild(k)),k.sheet&&(k.sheet.insertRule(`@media ${n.replace(/[{}]/g,``)} {body{ }}`,0),Yt.add(n))}catch(t){console.error(t)}}function be(n){return{matches:n===`all`||n===``,media:n,addListener:()=>{},removeListener:()=>{}}}var pe=(()=>{class n{create(t){return typeof MutationObserver>`u`?null:new MutationObserver(t)}static ɵfac=function(e){return new(e||n)};static ɵprov=se$1({token:n,factory:n.ɵfac})}return n})();var dn=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵmod=nt$1({type:n});static ɵinj=ke({providers:[pe]})}return n})();var Kt=new Map;var bt=class n{_appId=g(Ar);static _infix=`a${Math.floor(Math.random()*1e5).toString()}`;getId(o,t=!1){this._appId!==`ng`&&(o+=this._appId);let e=Kt.get(o);return e===void 0?e=0:e++,Kt.set(o,e),`${o}${t?n._infix+`-`:``}${e}`}static ɵfac=function(t){return new(t||n)};static ɵprov=se$1({token:n,factory:n.ɵfac})};var P;var Xt=[`color`,`button`,`checkbox`,`date`,`datetime-local`,`email`,`file`,`hidden`,`image`,`month`,`number`,`password`,`radio`,`range`,`reset`,`search`,`submit`,`tel`,`text`,`time`,`url`,`week`];function _n(){if(P)return P;if(typeof document!=`object`||!document)return P=new Set(Xt),P;let n=document.createElement(`input`);return P=new Set(Xt.filter(o=>(n.setAttribute(`type`,o),n.type===o))),P}var fe=new y$1(`MATERIAL_ANIMATIONS`);var Wt=null;function he(){return g(fe,{optional:!0})?.animationsDisabled||g(ty,{optional:!0})===`NoopAnimations`?`di-disabled`:(Wt??=g(ut).matchMedia(`(prefers-reduced-motion)`).matches,Wt?`reduced-motion`:`enabled`)}function tt(){return he()!==`enabled`}function Rn(n){return n!=null&&`${n}`!=`false`}var p=(function(n){return n[n.FADING_IN=0]=`FADING_IN`,n[n.VISIBLE=1]=`VISIBLE`,n[n.FADING_OUT=2]=`FADING_OUT`,n[n.HIDDEN=3]=`HIDDEN`,n})(p||{});var pt=class{_renderer;element;config;_animationForciblyDisabledThroughCss;state=p.HIDDEN;constructor(o,t,e,a=!1){this._renderer=o,this.element=t,this.config=e,this._animationForciblyDisabledThroughCss=a}fadeOut(){this._renderer.fadeOutRipple(this)}};var qt=L({passive:!0,capture:!0});var ft=class{_events=new Map;addHandler(o,t,e,a){let r=this._events.get(t);if(r){let s=r.get(e);s?s.add(a):r.set(e,new Set([a]))}else this._events.set(t,new Map([[e,new Set([a])]])),o.runOutsideAngular(()=>{document.addEventListener(t,this._delegateEventHandler,qt)})}removeHandler(o,t,e){let a=this._events.get(o);if(!a)return;let r=a.get(t);r&&(r.delete(e),r.size===0&&a.delete(t),a.size===0&&(this._events.delete(o),document.removeEventListener(o,this._delegateEventHandler,qt)))}_delegateEventHandler=o=>{let t=h(o);t&&this._events.get(o.type)?.forEach((e,a)=>{(a===t||a.contains(t))&&e.forEach(r=>r.handleEvent(o))})}};var G={enterDuration:225,exitDuration:150};var ve=800;var Qt=L({passive:!0,capture:!0});var Jt=[`mousedown`,`touchstart`];var te=[`mouseup`,`mouseleave`,`touchend`,`touchcancel`];var ge=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵcmp=nu({type:n,selectors:[[`ng-component`]],hostAttrs:[`mat-ripple-style-loader`,``],decls:0,vars:0,template:function(e,a){},styles:[`.mat-ripple {
  overflow: hidden;
  position: relative;
}
...
`],encapsulation:2})}return n})();var Ne=new y$1(`MAT_BUTTON_CONFIG`);function re(n){return n==null?void 0:WP(n)}var gt=(()=>{class n{_elementRef=g(_t$1);_ngZone=g(te$1);_animationsDisabled=tt();_config=g(Ne,{optional:!0});_focusMonitor=g(lt);_cleanupClick;_renderer=g(Ai);_rippleLoader=g(ae);_isAnchor;_isFab=!1;color;get disableRipple(){return this._disableRipple}set disableRipple(t){this._disableRipple=t,this._updateRippleDisabled()}_disableRipple=!1;get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._updateRippleDisabled()}_disabled=!1;ariaDisabled;disabledInteractive;tabIndex;set _tabindex(t){this.tabIndex=t}showProgress=UP(!1,{transform:$h});constructor(){g(LC).load(oe);let t=this._elementRef.nativeElement;this._isAnchor=t.tagName===`A`,this.disabledInteractive=this._config?.disabledInteractive??!1,this.color=this._config?.color??null,this._rippleLoader?.configureRipple(t,{className:`mat-mdc-button-ripple`})}ngAfterViewInit(){this._focusMonitor.monitor(this._elementRef,!0),this._isAnchor&&this._setupAsAnchor()}ngOnDestroy(){this._cleanupClick?.(),this._focusMonitor.stopMonitoring(this._elementRef),this._rippleLoader?.destroyRipple(this._elementRef.nativeElement)}focus(t=`program`,e){t?this._focusMonitor.focusVia(this._elementRef.nativeElement,t,e):this._elementRef.nativeElement.focus(e)}_getAriaDisabled(){return this.ariaDisabled!=null?this.ariaDisabled:this._isAnchor?this.disabled||null:this.disabled&&this.disabledInteractive?!0:null}_getDisabledAttribute(){return this.disabledInteractive||!this.disabled?null:!0}_updateRippleDisabled(){this._rippleLoader?.setDisabled(this._elementRef.nativeElement,this.disableRipple||this.disabled)}_getTabIndex(){return this._isAnchor?this.disabled&&!this.disabledInteractive?-1:this.tabIndex:this.tabIndex}_setupAsAnchor(){this._cleanupClick=this._ngZone.runOutsideAngular(()=>this._renderer.listen(this._elementRef.nativeElement,`click`,t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())}))}static ɵfac=function(e){return new(e||n)};static ɵdir=qn({type:n,hostAttrs:[1,`mat-mdc-button-base`],hostVars:15,hostBindings:function(e,a){e&2&&(Yr(`disabled`,a._getDisabledAttribute())(`aria-disabled`,a._getAriaDisabled())(`tabindex`,a._getTabIndex()),gu(a.color?`mat-`+a.color:``),Ki(`mat-mdc-button-progress-indicator-shown`,a.showProgress())(`mat-mdc-button-disabled`,a.disabled)(`mat-mdc-button-disabled-interactive`,a.disabledInteractive)(`mat-unthemed`,!a.color)(`_mat-animation-noopable`,a._animationsDisabled))},inputs:{color:`color`,disableRipple:[2,`disableRipple`,`disableRipple`,$h],disabled:[2,`disabled`,`disabled`,$h],ariaDisabled:[2,`aria-disabled`,`ariaDisabled`,$h],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,$h],tabIndex:[2,`tabIndex`,`tabIndex`,re],_tabindex:[2,`tabindex`,`_tabindex`,re],showProgress:[1,`showProgress`]}})}return n})();var ie=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵmod=nt$1({type:n});static ɵinj=ke({imports:[Tg]})}return n})();var ce=[[[``,8,`material-icons`,3,`iconPositionEnd`,``],[`mat-icon`,3,`iconPositionEnd`,``],[``,`matButtonIcon`,``,3,`iconPositionEnd`,``]],`*`,[[``,`iconPositionEnd`,``,8,`material-icons`],[`mat-icon`,`iconPositionEnd`,``],[``,`matButtonIcon`,``,`iconPositionEnd`,``]],[[``,`progressIndicator`,``]]];var de=[`.material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])`,`*`,`.material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]`,`[progressIndicator]`];function xe(n,o){n&1&&(du(0,`div`,2),hu(1,3),fu())}function we(n,o){n&1&&(du(0,`div`,2),hu(1,3),fu())}var Me=`.mat-mdc-fab-base {
...
`],encapsulation:2})}return n})();function Ee(n){return n.hasAttribute(`mat-raised-button`)?`elevated`:n.hasAttribute(`mat-stroked-button`)?`outlined`:n.hasAttribute(`mat-flat-button`)?`filled`:n.hasAttribute(`mat-button`)?`text`:null}var De=new y$1(`mat-mdc-fab-default-options`,{providedIn:`root`,factory:()=>yt});var yt={color:`accent`};var xa=(()=>{class n extends gt{_options=g(De,{optional:!0});_isFab=!0;constructor(){super(),this._options=this._options||yt,this.color=this._options.color||yt.color}static ɵfac=function(e){return new(e||n)};static ɵcmp=nu({type:n,selectors:[[`button`,`mat-mini-fab`,``],[`a`,`mat-mini-fab`,``],[`button`,`matMiniFab`,``],[`a`,`matMiniFab`,``]],hostAttrs:[1,`mdc-fab`,`mat-mdc-fab-base`,`mdc-fab--mini`,`mat-mdc-mini-fab`],exportAs:[`matButton`,`matAnchor`],features:[th],ngContentSelectors:de,decls:8,vars:5,consts:[[1,`mat-mdc-button-persistent-ripple`],[1,`mdc-button__label`],[1,`mat-mdc-button-progress-indicator-container`],[1,`mat-focus-indicator`],[1,`mat-mdc-button-touch-target`]],template:function(e,a){e&1&&(pu(ce),ch(0,`span`,0),hu(1),du(2,`span`,1),hu(3,1),fu(),hu(4,2),eI(5,we,2,0,`div`,2),ch(6,`span`,3)(7,`span`,4)),e&2&&(Ki(`mdc-button__ripple`,!a._isFab)(`mdc-fab__ripple`,a._isFab),iD(5),tI(a.showProgress()?5:-1))},styles:[Me],encapsulation:2})}return n})();var wa=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵmod=nt$1({type:n});static ɵinj=ke({imports:[ie,Tg]})}return n})();var Ie=[`*`];var Te=new y$1(`MAT_CARD_CONFIG`);var Ra=(()=>{class n{appearance;constructor(){let t=g(Te,{optional:!0});this.appearance=t?.appearance||`raised`}static ɵfac=function(e){return new(e||n)};static ɵcmp=nu({type:n,selectors:[[`mat-card`]],hostAttrs:[1,`mat-mdc-card`,`mdc-card`],hostVars:8,hostBindings:function(e,a){e&2&&Ki(`mat-mdc-card-outlined`,a.appearance===`outlined`)(`mdc-card--outlined`,a.appearance===`outlined`)(`mat-mdc-card-filled`,a.appearance===`filled`)(`mdc-card--filled`,a.appearance===`filled`)},inputs:{appearance:`appearance`},exportAs:[`matCard`],ngContentSelectors:Ie,decls:1,vars:0,template:function(e,a){e&1&&(pu(),hu(0))},styles:[`.mat-mdc-card {
  display: flex;
...
`],encapsulation:2})}return n})();var Fa=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵdir=qn({type:n,selectors:[[`mat-card-content`]],hostAttrs:[1,`mat-mdc-card-content`]})}return n})();var Oa=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵmod=nt$1({type:n});static ɵinj=ke({imports:[Tg]})}return n})();var _t=`boardgame:players`;var me=class n{playersSubject=new sr(this.load());players$=this.playersSubject.asObservable();load(){try{let o=localStorage.getItem(_t);return o?JSON.parse(o):[]}catch{return[]}}save(o){try{localStorage.setItem(_t,JSON.stringify(o))}catch{}}getPlayers(){return[...this.playersSubject.value]}addPlayer(o){let t=(o||``).trim();if(!t)return;let e=[...this.playersSubject.value,{id:Date.now().toString(),name:t,score:0}];this.playersSubject.next(e),this.save(e)}removePlayer(o){let t=this.playersSubject.value.filter(e=>e.id!==o);this.playersSubject.next(t),this.save(t)}updateScore(o,t){let e=this.playersSubject.value.map(a=>a.id===o?$(L$1({},a),{score:a.score+t}):a);this.playersSubject.next(e),this.save(e)}completeRound(o){let t=this.playersSubject.value.map(e=>e.id in o&&Number.isFinite(o[e.id])?$(L$1({},e),{score:e.score+(o[e.id]??0)}):e);this.playersSubject.next(t),this.save(t)}resetScores(){let o=this.playersSubject.value.map(t=>$(L$1({},t),{score:0}));this.playersSubject.next(o),this.save(o)}resetGame(){this.playersSubject.next([]),localStorage.removeItem(_t)}static ɵfac=function(t){return new(t||n)};static ɵprov=M({token:n,factory:n.ɵfac,providedIn:`root`})};export{Rn as a,dn as c,wa as d,x as f,Ra as i,me as l,y as m,Na as n,_n as o,xa as p,Oa as r,bt as s,Fa as t,tt as u};