...
`],encapsulation:2})}return n})();var Fa=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵdir=qn({type:n,selectors:[[`mat-card-content`]],hostAttrs:[1,`mat-mdc-card-content`]})}return n})();var Oa=(()=>{class n{static ɵfac=function(e){return new(e||n)};static ɵmod=nt$1({type:n});static ɵinj=ke({imports:[Tg]})}return n})();var _t=`boardgame:players`;var me=class n{playersSubject=new sr(this.load());players$=this.playersSubject.asObservable();roundCountSubject=new sr(0);roundCount$=this.roundCountSubject.asObservable();load(){try{let o=localStorage.getItem(_t);return o?JSON.parse(o):[]}catch{return[]}}save(o){try{localStorage.setItem(_t,JSON.stringify(o))}catch{}}getPlayers(){return[...this.playersSubject.value]}addPlayer(o){let t=(o||``).trim();if(!t)return;let e=[...this.playersSubject.value,{id:Date.now().toString(),name:t,score:0}];this.playersSubject.next(e),this.save(e)}removePlayer(o){let t=this.playersSubject.value.filter(e=>e.id!==o);this.playersSubject.next(t),this.save(t)}updateScore(o,t){let e=this.playersSubject.value.map(a=>a.id===o?$(L$1({},a),{score:a.score+t}):a);this.playersSubject.next(e),this.save(e)}completeRound(o){let t=this.playersSubject.value.map(e=>e.id in o&&Number.isFinite(o[e.id])?$(L$1({},e),{score:e.score+(o[e.id]??0)}):e);this.playersSubject.next(t),this.save(t),this.roundCountSubject.next(this.roundCountSubject.value+1)}resetScores(){let o=this.playersSubject.value.map(t=>$(L$1({},t),{score:0}));this.playersSubject.next(o),this.save(o),this.roundCountSubject.next(0)}resetGame(){this.playersSubject.next([]),localStorage.removeItem(_t)}static ɵfac=function(t){return new(t||n)};static ɵprov=M({token:n,factory:n.ɵfac,providedIn:`root`})};export{Rn as a,dn as c,wa as d,x as f,Ra as i,me as l,y as m,Na as n,_n as o,xa as p,Oa as r,bt as s,Fa as t,tt as u};